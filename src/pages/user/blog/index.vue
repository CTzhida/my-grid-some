                    ...
                    <el-row>
                        ...
                        <el-col :span="8">
                            <div style="text-align: right;">
                                ...
                                <el-button @click="editBlog(item.node.id)" style="padding: 3px 0" type="text" icon="el-icon-edit"></el-button>
                                <el-button @click="deleteBlog(item.node.id)" style="padding: 3px 0" type="text" icon="el-icon-delete" ></el-button>
                            </div>
                        </el-col>
                    </el-row>
                </div>
...
<page-query>
query ($page:Int) {
  blog: allStrapiBlog(sortBy:"id", order: DESC,limit:10, page: $page  ){
    edges {
      node {
        id
        title
    ...
    export default {
        ...
        methods: {
            list() {
              ...
              this.blogs = this.$page.blog.edges
                // this.blogs = []
                // this.loading = true
            ...
            search() {
                for (let i = 0; i < this.blogs.length; i++) {
                    this.blogs[i].node.hide = this.blogs[i].node.title.indexOf(this.searchKey) < 0
                }
            ...
            editBlog(index) {
                ...
                //     return
                // }
                this.$router.push('/user/blog/edit/' + index)
            },
            deleteBlog(index) {
